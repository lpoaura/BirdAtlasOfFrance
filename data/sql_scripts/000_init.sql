...
/* Create table to list excluded taxa */
        ...
        (
            ...
            wintering_area_type  INT REFERENCES ref_geo.bib_areas_types (id_type) DEFAULT ref_geo.get_id_area_type('ATLAS_GRID'),
            all_period_area_type INT REFERENCES ref_geo.bib_areas_types (id_type) DEFAULT ref_geo.get_id_area_type('ATLAS_GRID'),
            breeding_area_type   INT REFERENCES ref_geo.bib_areas_types (id_type) DEFAULT ref_geo.get_id_area_type('ATLAS_GRID')
        );
--
--         ALTER TABLE atlas.t_taxa
--             ADD COLUMN wintering_area_type INT REFERENCES ref_geo.bib_areas_types (id_type) DEFAULT ref_geo.get_id_area_type('ATLAS_GRID');
--         ALTER TABLE atlas.t_taxa
--             ADD COLUMN all_period_area_type INT REFERENCES ref_geo.bib_areas_types (id_type) DEFAULT ref_geo.get_id_area_type('ATLAS_GRID');
--         ALTER TABLE atlas.t_taxa
--             ADD COLUMN breeding_area_type INT REFERENCES ref_geo.bib_areas_types (id_type) DEFAULT ref_geo.get_id_area_type('ATLAS_GRID');
        ...
        COMMENT ON COLUMN atlas.t_taxa.wintering_area_type IS 'Area type for wintering map representation';
        COMMENT ON COLUMN atlas.t_taxa.all_period_area_type IS 'Area type for all period map representation';
        COMMENT ON COLUMN atlas.t_taxa.breeding_area_type IS 'Area type for breeding map representation';
