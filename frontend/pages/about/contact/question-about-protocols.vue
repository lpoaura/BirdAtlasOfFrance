  ...
  <v-container fluid>
    ...
    <section v-show="!validForm" class="Section">
      <div class="ContactFormContent">
        ...
        />
        <span v-show="alerts.noSelectedProtocol" class="ContactFormAlert">
          Veuillez sélectionner une méthode de prospection
          <i
            class="v-icon mdi mdi-close-circle ContactFormAlertCloseIcon"
            @click="deleteAlert"
          ></i>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      } else if (!this.selectedProtocol) {
        this.alerts.noSelectedProtocol = true
