...
Contribuer à Oiseaux de France peut se faire de bien des manières, en fonction de votre **disponibilité** et de votre **niveau de connaissances ornithologiques**. Le plus simple est de saisir systématiquement vos observations, idéalement **par liste complète**, en attribuant un **code de reproduction** pour les oiseaux nicheurs.
